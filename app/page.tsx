...
export default function Page() {
  return (
    <section>
      ...
      <p className="mb-4 ">
        {`I'm a computer engineering student at University of Waterloo. I do full stack development, firmware at school rocketry team, and I'm currently working on building a interpreter/compiler in Go! Also checkout my photography work `}<a className="mb-4 text-black-500 underline" href='https://www.instagram.com/punchdii/'>here</a>
      </p>
